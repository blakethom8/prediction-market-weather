        ...
        results.append(
            {
                ...
                'settlement_source': row[6],
                'minutes_to_close': row[7],
                'price_yes_mid': row[8],
                'price_yes_ask': row[9],
                'price_yes_bid': row[10],
                'fair_prob': row[11],
                'edge_vs_mid': row[12],
                'edge_vs_ask': row[13],
                'candidate_rank': row[14],
                'candidate_bucket': row[15],
                'board_notes': json.loads(row[16]) if row[16] else {},
            }
        )
    return results
